...
def register_handlers(dp: Dispatcher):
    ...
    @dp.message(lambda message: message.text == "📊 КУД")
    @error_handler
    async def show_kud_info(message: types.Message):
        """Информация о КУД"""
        await message.answer(
            Instructions.kud(),
            disable_web_page_preview=True
    ...
    @dp.message(lambda message: message.text == "📋 ИУП")
    @error_handler
    async def show_iup_info(message: types.Message):
        """Информация об ИУП"""
        await message.answer(
            Instructions.iup(),
            disable_web_page_preview=True
